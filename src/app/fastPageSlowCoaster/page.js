...
//we are going to desctructure the Suspense component from React
...
export default function fastPageSlowComponent() {
  return (
    <>
      ...
      <p>Keep an eye for the slow component coming</p>
      {/* I am wrapping the SlowComponent within Suspense  */}
      {/* The fallback prop contains the elemnt we want to show the user while the component loads  */}
      <Suspense
        fallback={
          <>
            <h1 className="text-purple-500">
              Look, it&apos;s a loading fallback in suspense...
            </h1>
            <Image
              src={
